...
<html lang="en">
  <head>
    ...
    <title>Mina Minks | Lash Studio Management System | Services </title>
...
?>
                <div class="col-lg-4 col-md-6 col-sm-6 propClone">
                 <img src="admin/images/<?php echo $row['Image']?>" alt="product" height="300" width="300" class="img-responsive about-me">
